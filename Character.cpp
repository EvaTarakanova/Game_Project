...
Character::Character(int x, int y, int sym, const char* name, const TCODColor& color) : x(x), y(y), sym(sym), name(name), color(color), blocks(true), attacker(nullptr), target(nullptr), ai(nullptr) {}
...
void Character::update()
{
    ...
    std::cout << " вас засёк, он жаждет получить зачёт \n";
}
